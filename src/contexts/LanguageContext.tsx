...
const translations = {
  vi: {
    ...
    'landing.faq.q1.question': 'CoinTracker là gì?',
    'landing.faq.q1.answer': 'CoinTracker là một nền tảng theo dõi giá tiền điện tử theo thời gian thực, cung cấp thông tin chi tiết về hơn 10.000+ loại tiền điện tử từ các sàn giao dịch trên toàn thế giới.',
    'landing.faq.q2.question': 'Các tính năng chính của CoinTracker là gì?',
    'landing.faq.q2.answer': 'CoinTracker cung cấp Dashboard toàn diện, biểu đồ nâng cao, tìm kiếm thông minh, danh sách sàn giao dịch, tin tức crypto cập nhật và các tính năng bảo mật tài khoản.',
    'landing.faq.q3.question': 'CoinTracker sử dụng những nguồn dữ liệu nào?',
    'landing.faq.q3.answer': 'Chúng tôi tổng hợp dữ liệu thời gian thực từ các API tiền điện tử uy tín như CoinMarketCap, CoinGecko, Alternative.me và CryptoPanic để đảm bảo độ chính xác cao nhất.',
    'landing.faq.q4.question': 'CoinTracker có miễn phí không?',
    'landing.faq.q4.answer': 'Có, CoinTracker hoàn toàn miễn phí để sử dụng. Chúng tôi sử dụng các API miễn phí và cung cấp tất cả các tính năng cốt lõi mà không yêu cầu đăng ký trả phí.',
    'landing.faq.q5.question': 'Độ chính xác của dữ liệu tiền điện tử như thế nào?',
    'landing.faq.q5.answer': 'Chúng tôi tổng hợp dữ liệu thời gian thực từ nhiều API tiền điện tử uy tín như CoinMarketCap và CoinGecko để đảm bảo độ chính xác cao nhất. Dữ liệu được cập nhật thường xuyên để phản ánh điều kiện thị trường hiện tại.',
    'landing.faq.q6.question': 'Dữ liệu cá nhân và ví tiền điện tử của tôi có an toàn không?',
    'landing.faq.q6.answer': 'Có, chúng tôi ưu tiên bảo mật. Xác thực người dùng được xử lý thông qua các phương pháp an toàn như Google OAuth và chữ ký ví MetaMask. Chúng tôi sử dụng quản lý phiên dựa trên JWT và không lưu trữ khóa riêng tư của ví của bạn.',
    'landing.faq.q7.question': 'Tôi có thể mong đợi những tính năng mới nào trong tương lai?',
    'landing.faq.q7.answer': 'Chúng tôi không ngừng nỗ lực cải thiện CoinTracker. Các tính năng sắp tới bao gồm theo dõi danh mục đầu tư người dùng, cảnh báo và thông báo giá có thể tùy chỉnh, các loại biểu đồ nâng cao hơn và tối ưu hóa hiệu suất. Chúng tôi cũng có kế hoạch triển khai hỗ trợ PWA và triển khai Docker.',
    'landing.faq.q8.question': 'Làm thế nào để thay đổi ngôn ngữ hoặc chủ đề?',
    'landing.faq.q8.answer': 'Bạn có thể dễ dàng thay đổi ngôn ngữ giữa tiếng Anh và tiếng Việt, hoặc chuyển đổi giữa chủ đề sáng và tối thông qua cài đặt ứng dụng.',
    'landing.faq.q9.question': 'Tôi có thể tìm hỗ trợ ở đâu nếu có vấn đề?',
    'landing.faq.q9.answer': 'Nếu bạn gặp bất kỳ vấn đề nào, vui lòng truy cập Trung tâm trợ giúp của chúng tôi hoặc liên hệ với nhóm hỗ trợ của chúng tôi thông qua trang liên hệ.',
  },
